...
contract UnstoppableVault is IERC3156FlashLender, ReentrancyGuard, Owned, ERC4626 {
    ...
    function flashFee(address _token, uint256 _amount) public view returns (uint256 fee) {
        ...
        // @audit Offer zero fee flash loan during grace period
     ...
     * @inheritdoc IERC3156FlashLender
     */
    // @audit To stop offer flash loans
    // 1. try make totalAssets() revert: impossible
    // 2. try alter asset token: impossible
    // 3. try empty the vault: impossible
    // 4. try InvalidBalance()
